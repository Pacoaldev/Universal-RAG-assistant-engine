...
class Settings(BaseSettings):
    ...
    ORGANIZATION_NAME: str = Field(
        default="Clínica Veterinaria Maskotas", description="Organización o dominio"
    )
    ...
    STORAGE_TYPE: str = Field(
        default="local", description="Tipo de almacenamiento: local | firestore"
    )
    ...
    FIREBASE_CREDENTIALS_PATH: Optional[Path] = Field(
        default=None, description="Ruta a las credenciales de servicio de Firebase"
    )
    ...
    def default_system_prompt(self) -> str:
        ...
        return (
            ...
            "Tu objetivo es proporcionar información precisa, empática y útil "
            "sobre nuestros servicios, horarios y consultas generales. "
